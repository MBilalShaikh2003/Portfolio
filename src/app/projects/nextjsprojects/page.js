    ...
    <div className="bg-[#1C1C1C] text-white min-h-screen flex flex-col">
      ...
      <div className="flex-1 px-8 py-12 flex justify-center">
        ...
        <div className="flex flex-col md:flex-row gap-8 items-center">
          {/* OLX Clone Project */}
          <div className="bg-[#242424] border border-[#8B16FB] rounded-lg p-6 w-80 shadow-lg">
            ...
            <Link href="https://booking-hotel-next-3hwbj2n2w-bilals-projects-ba93d5df.vercel.app/">
